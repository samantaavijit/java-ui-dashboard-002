...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        switch (type) {
            case SUCCESS:
                ...
                break;
            case INFO:
                lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/info.png")));
                lbMessage.setText("Info");
                break;
            default:
                lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/warning.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/success.png"))); // NOI18N
