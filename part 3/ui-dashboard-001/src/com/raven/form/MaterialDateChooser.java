...
public class MaterialDateChooser extends JDateChooser {
    ...
    public MaterialDateChooser() {
        ...
        target = new TimingTargetAdapter() {
            @Override
            public void begin() {
                animateHintText = getDate() != null && getDate().toString().equals("");
            }
    ...
    public void setDate(Date date) {
        if (getDate() != null && !getDate().toString().equals(date.toString())) {
            showing(date.toString().equals(""));
        }
        super.setDate(date);
    }
}
